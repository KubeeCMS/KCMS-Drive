...
class Gallery
{
    ...
    public function renderFile($item, $hidden = false)
    {
        ...
        $link = USEYOURDRIVE_ADMIN_URL."?action=useyourdrive-download&account_id={$this->_folder['folder']->get_account_id()}&id=".urlencode($item->get_id()).'&dl=1&listtoken='.$this->get_processor()->get_listtoken();
