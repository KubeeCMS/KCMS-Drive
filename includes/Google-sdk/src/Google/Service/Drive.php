...
class UYDGoogle_Service_Drive_TeamDrives_Resource extends UYDGoogle_Service_Resource
{
     ...
     */
    public function create(UYDGoogle_Service_Drive_TeamDrive $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('create', [$params], 'UYDGoogle_Service_Drive_TeamDrive');
    }
     ...
     * @param array  $optParams
     *
     * @return UYDGoogle_Service_Drive_TeamDriveList
     */
    public function get($fileId, $optParams = [])
    {
        $params = ['teamDriveId' => $fileId];
        ...
        return $this->call('get', [$params], 'UYDGoogle_Service_Drive_TeamDriveList');
    }
    ...
    public function listDrives($optParams = [])
    {
        ...
        return $this->call('list', [$params], 'UYDGoogle_Service_Drive_TeamDriveList');
    }
     ...
     * @return UYDGoogle_Service_Drive_TeamDriveList
     */
    public function update($fileId, UYDGoogle_Service_Drive_TeamDrive $postBody, $optParams = [])
    {
        $params = ['teamDriveId' => $fileId, 'postBody' => $postBody];
        $params = array_merge($params, $optParams);

        return $this->call('update', [$params], 'UYDGoogle_Service_Drive_TeamDriveList');
    }
}
