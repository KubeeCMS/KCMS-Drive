    ...
    <div class="wrap">
      ...
      <div class="useyourdrive-panel useyourdrive-panel-right">
        ...
        <div id="settings_layout" class="useyourdrive-tab-panel">
          ...
          <div class=" forfilebrowser forsearch forgallery">
            ...
            <div class="showfiles-options">
              <div class="useyourdrive-option-title"><?php _e('Amount of files','wpcloudplugins'); ?>
              </div>
              <div class="useyourdrive-option-description"><?php _e('Number of files to show','wpcloudplugins'); ?>. <?php _e('Can be used for instance to only show the last 5 updated documents','wpcloudplugins'); ?>. <?php _e('Leave this field empty or set it to -1 for no limit','wpcloudplugins'); ?></div>
        ...
        <div id="settings_notifications" class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-option-description"><?php _e('On which email address would you like to receive the notification? You can use <code>%admin_email%</code>, <code>%user_email%</code> (user that executes the action) and <code>%linked_user_email%</code> (Private Folders owners)','wpcloudplugins'); ?>.</div>
        ...
        <div id="settings_manipulation" class="useyourdrive-tab-panel">
          ...
          <div class="option forfilebrowser forgallery forsearch">
            ...
            <div class="useyourdrive-option-title"><?php _e('Edit descriptions','wpcloudplugins'); ?>
              <div class="useyourdrive-onoffswitch">
        ...
        <div id="settings_permissions" class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-accordion">
            ...
            <div class="option useyourdrive-permissions-box forfilebrowser forgallery forsearch editdescription-options ">
              <div class="useyourdrive-accordion-title useyourdrive-option-title"><?php _e('Who can edit descriptions?','wpcloudplugins'); ?></div>
              <div>
                <?php
