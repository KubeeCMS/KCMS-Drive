  ...
  <form id="useyourdrive-options" method="post" action="options.php">
    ...
    <div class="wrap">
      <div class="useyourdrive-header">
        ...
        <div class="useyourdrive-title">Use-your-Drive <?php _e('Settings','wpcloudplugins'); ?></div>
      </div>
      ...
      <div id="" class="useyourdrive-panel useyourdrive-panel-left">      
        ...
        <ul class="useyourdrive-nav-tabs">
          <li id="settings_help_tab" data-tab="settings_help"><a href="https://1.envato.market/c/1260925/275988/4415?u=https%3A%2F%2Fcodecanyon.net%2Fitem%2Foutofthebox-dropbox-plugin-for-wordpress-%2F5529125" target="_blank" style="color:#522058;">Dropbox <i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a></li>
          <li id="settings_help_tab" data-tab="settings_help"><a href="https://1.envato.market/c/1260925/275988/4415?u=https%3A%2F%2Fcodecanyon.net%2Fitem%2Fshareonedrive-onedrive-plugin-for-wordpress%2F11453104" target="_blank" style="color:#522058;">OneDrive <i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a></li>
          <li id="settings_help_tab" data-tab="settings_help"><a href="https://1.envato.market/c/1260925/275988/4415?u=https%3A%2F%2Fcodecanyon.net%2Fitem%2Fletsbox-box-plugin-for-wordpress%2F8204640" target="_blank" style="color:#522058;">Box <i class="fas fa-external-link-square-alt" aria-hidden="true"></i></a></li>
        </ul> 
      ...
      <div class="useyourdrive-panel useyourdrive-panel-right">
        ...
        <div id="settings_userfolders"  class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-accordion">
            ...
            <div>
              ...
              <div class="useyourdrive-option-description"><?php _e('Template name for automatically created Private Folders. You can use <code>%user_login%</code>, <code>%user_email%</code>, <code>%display_name%</code>, <code>%ID%</code>, <code>%user_role%</code>, <code>%jjjj-mm-dd%</code>','wpcloudplugins'); ?>.</div>
        ...
        <div id="settings_advanced"  class="useyourdrive-tab-panel">
          ...
          <?php if (false === $network_wide_authorization) { ?>
              ...
              <div class="useyourdrive-option-title"><?php _e('Using Google G Suite?','wpcloudplugins'); ?>
                <div class="useyourdrive-onoffswitch">
              ...
              <div class="useyourdrive-suboptions gsuite <?php echo ($using_gsuite) ? '' : 'hidden'; ?> ">
                <div class="useyourdrive-option-title"><?php _e('Your Google G Suite Domain','wpcloudplugins'); ?></div>
                ...
                <div class="useyourdrive-option-title"><?php _e('Enable Team Drives','wpcloudplugins'); ?>
                  <div class="useyourdrive-onoffswitch">
          ...
          <div class="useyourdrive-option-title"><?php _e('Shortlinks API','wpcloudplugins'); ?></div>
        ...
        <div id="settings_notifications"  class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-accordion">
            ...
            <div>
              ...
              <div class="useyourdrive-option-description"><?php _e('Available placeholders','wpcloudplugins'); ?>: 
                <code>%site_name%</code>, 
        ...
        <div id="settings_stats"  class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-suboptions events_options <?php echo ('Yes' === $this->settings['log_events']) ? '' : 'hidden'; ?> ">
            ...
            <div class="event_summary <?php echo ('Yes' === $this->settings['event_summary']) ? '' : 'hidden'; ?> ">
              ...
              <select type="text" name="use_your_drive_settings[event_summary_period]" id="shortlinks">
              ...
              <input class="useyourdrive-option-input-large" type="text" name="use_your_drive_settings[event_summary_recipients]" id="lostauthorization_notification" value="<?php echo esc_attr($this->settings['event_summary_recipients']); ?>" placeholder="<?php echo get_option('admin_email'); ?>">  
            </div>
          </div>
        ...
        <div id="settings_tools"  class="useyourdrive-tab-panel">
          ...
          <div class="useyourdrive-option-title"><?php _e('Reset Cache','wpcloudplugins'); ?></div>
