      ...
      <td>
        ...
        <?php } else { ?>
            <mark class="error"><span class="dashicons dashicons-warning"></span>
              ...
              echo wp_kses_post(sprintf(__('Your store is not using HTTPS. <a href="%s" target="_blank">Learn more about HTTPS and SSL Certificates</a>.', 'wpcloudplugins'), 'https://www.wpbeginner.com/wp-tutorials/how-to-add-ssl-and-https-in-wordpress/'));
              ?>
            </mark>
        <?php } ?>
      </td>
