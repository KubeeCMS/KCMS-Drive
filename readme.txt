...
= 1.14 =
1.14 is a major update introducing support for multiple accounts. After this update it isn't possible to fallback to an older version. Make a full site backup before upgrading.
