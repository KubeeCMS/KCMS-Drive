...
/*
  Plugin Name: KCMS Drive
  Plugin URI: https://github.com/KubeeCMS/KCMS-Drive/_
  Description: Start using the Cloud even more efficiently by integrating it on your website.
  Version: 1.15.5
  Author: Kubee CMS
 ...
 */
// SYSTEM SETTINGS
define('USEYOURDRIVE_VERSION', '1.15.5');
...
class Main
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_nopriv_useyourdrive-add-folder', [&$this, 'start_process']);
        add_action('wp_ajax_useyourdrive-add-folder', [&$this, 'start_process']);
...
<p>Your account isn't (yet) configured to access this content. Please contact the administrator of the site if you would like to have access. The administrator can link your account to the right content.</p>", 'wpcloudplugins');
    ...
    public function load_scripts()
    {
        ...
        $localize = [
            ...
            'str_addfolder_title' => __('Add folder', 'wpcloudplugins'),
            'str_addfolder' => __('New folder', 'wpcloudplugins'),
    ...
    public function ask_for_review($force = false)
    {
        ...
        <div class="enjoying-container go-for-it" style="display:none">
          ...
          <div class="enjoying-buttons">
            ...
            <a class="enjoying-button default" id="enjoying-button-go-for-it-yes" href="https://1.envato.market/c/1260925/275988/4415?u=https%3A%2F%2Fcodecanyon.net%2Fitem%2Fuseyourdrive-google-drive-plugin-for-wordpress%2Freviews%2F6219776" target="_blank"><?php _e('Ok, sure!', 'wpcloudplugins'); ?></a>
          </div>
        </div>
        ...
        <div class="enjoying-container mwah" style="display:none">
          ...
          <div class="enjoying-buttons">
            ...
            <a class="enjoying-button default" id="enjoying-button-mwah-yes" href="https://docs.google.com/forms/d/e/1FAIpQLSct8a8d-_7iSgcvdqeFoSSV055M5NiUOgt598B95YZIaw7LhA/viewform?usp=pp_url&entry.83709281=Use-your-Drive+(Google+Drive)&entry.450972953&entry.1149244898" target="_blank"><?php _e('Ok, sure!', 'wpcloudplugins'); ?></a>
          </div>
        </div>
    ...
    public function synchronize_cache()
    {
        ...
        foreach ($this->get_accounts()->list_accounts() as $account_id => $account) {
            ...
            try {
                ...
                error_log('[WP Cloud Plugin message]: '.sprintf('Use-your-Drive WP WP Cron job has encountered an error: %s', $ex->getMessage()));
